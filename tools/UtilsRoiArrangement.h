...
namespace PyramidTiffData {
    ...
    [[nodiscard]] RoiLayout compute_roi_layout(const std::vector<Roi>& rois, uint32_t padding = 16, std::vector<Roi>* tissues = nullptr, const std::vector<std::string>* roi_oder = nullptr);
