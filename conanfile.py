...
class MaskedPyramidImagesPluginConan(ConanFile):
    """Class to package the MaskedPyramidImages-Plugin using conan
    ...
    name = "MaskedPyramidImagesPlugin"
    description = "Compute principle components"
    topics = ("manivault", "plugin", "data", "loader", "MaskedPyramidImages")
    url = "https://github.com/ManiVaultStudio/MaskedPyramidImages-Plugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/MaskedPyramidImagesPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/MaskedPyramidImagesPlugin")
        cmake.verbose = True
        return cmake
